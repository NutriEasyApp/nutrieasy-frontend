  ...
  return (
    <KeyboardAvoidingView style={styles.background}>
      ...
      <Animated.View style={[styles.container, {
        ...
        <TextInput style={styles.input} placeholder="Nome" autoCorrect={false} onChangeText={() => { }}></TextInput>
        <TextInput style={styles.input} placeholder="Peso" autoCorrect={false} onChangeText={() => { }}></TextInput>
        <TextInput style={styles.input} placeholder="Data de Nascimento" autoCorrect={false} onChangeText={() => { }}></TextInput>
